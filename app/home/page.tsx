      ...
      <main className="portfolio-shell">
        ...
        <section id="top" className="hero reveal reveal-2" data-hero-stage>
          ...
          <div className="hero-meta">
            <p>I&apos;m Ayush, a 14-year-old developer in the Bay Area creating AI-powered education tools, iOS apps, and experimental web products.</p>
        ...
        <section id="about" className="section-grid depth-section" data-reveal-3d>
          ...
          <div className="section-copy large-copy">
            <p>I care about making technology feel <em>clear, useful, and crafted.</em> My work sits where product thinking, engineering, and visual design meet.</p>
            <p className="muted-copy">I build with SwiftUI, Next.js, TypeScript, React, Firebase, and AI APIs. Most of my ideas begin as a problem I personally want solved, then become products other students can use.</p>
          </div>
        </section>

        <section id="work" className="work-section depth-section" data-reveal-3d>
          <div className="section-heading"><span>work</span></div>
                ...
                <div className="project-side">
                  ...
                  <span>
                    {project.links.map((link, linkIndex) => (
                      <span key={link.href}>
                        {linkIndex > 0 ? " · " : ""}
                        <a href={link.href} target={link.href.startsWith("http") ? "_blank" : undefined} rel="noreferrer">{link.label} ↗</a>
                      </span>
                    ))}
                  </span>
                </div>
